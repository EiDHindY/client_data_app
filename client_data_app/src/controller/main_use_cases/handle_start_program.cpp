...
namespace start_program_controller
{
    ...
    menu_options::enMenuOptions start_program()
    {
        ...
        // Memory: Stack-allocated path object; passed by const reference to avoid copies.
        // CPU: Queries OS for executable location and caches result.
        ...
        // Data type: unsigned short - range [0, 65535], sufficient for 1-6 menu options.
        // Memory: Stack-allocated (2 bytes).
        ...
        // Data type: inputs::enReadResult - enumeration (Invalid_input, Out_of_range, pass).
        // Memory: Stack-allocated enum value (typically 1-4 bytes).
        ...
        // CPU: Repeats std::getline calls and input stream parsing until pass condition.
        while (user_choice != inputs::enReadResult::pass)
        {
            // Read one complete line from standard input, including spaces and special characters.
            // Memory: Allocates/reallocates line string as needed; previous content discarded.
            // CPU: Blocks on I/O until newline encountered.
            ...
            // CPU: Initializes internal buffer with line content; read position at start.
            input = std::istringstream(line);

            // Attempt to extract and validate a number from [1, 6] from the stream.
            // Data type: inputs::enReadResult - indicates extraction success/failure and range check.
            // Memory: operation_number modified only if extraction succeeds.
            // CPU: Pattern matching within stream buffer for numeric conversion.
            ...
            // Check if extraction succeeded but the value is outside the valid range [1, 6].
        ...
        // Cast the validated unsigned short to the corresponding menu option enumeration.
        // Data type: menu_options::enMenuOptions - enum with 6 possible values (1-6 mapped to options).
        // Memory: Stack-allocated; stored temporarily before return.
        // CPU: Direct value cast; no computation required.
        menu_options::enMenuOptions result = static_cast<menu_options::enMenuOptions>(operation_number);
